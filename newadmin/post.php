        ...
        <table class="table" id="myTable">
            ...
            <tbody>
                ...
                while($row= mysqli_fetch_assoc($result)){
                    ...
                    <td><button onclick='approve(".$row['id'].",1)'>Approve</button>
                    <button onclick='approve(".$row['id'].",2)'>Suspend</button>
                    <button class='edit btn btn-sm btn-primary' id=".$row['id'].">Aprove</button> <button class='delete btn btn-sm btn-danger' id=d".$row['id'].">Suspend</button></td>
                    </tr>";
                    }
                ?>
            </tbody>
